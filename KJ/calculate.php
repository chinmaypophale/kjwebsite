...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="index.html"><img src="img/logos/kaijing logo about.png" > </a>
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-3">
        <form align="center">
            <h2>Kaijing Calculator <small>It's free and always will be.</small></h2>
            <hr class="colorgraph">
            <div class="row">
            ...
            <!-- <div class="form-group">
              ...
              <div class="form-group">
              <input type="text" name="number" id="email" class="form-control input-lg" placeholder="Contact No" tabindex="4" required>
              </div>
            <div class="form-group">
